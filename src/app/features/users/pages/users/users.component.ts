  ...
  ngOnInit(): void {
    ...
    this.pageContents = {
      info: {
        title: '使用者資料頁面',
        cols: [
          { field: 'username', header: '帳號', width: '8rem' },
          { field: 'name', header: '姓名', width: '8rem' },
          { field: 'email', header: '信箱', width: '8rem' },
          { field: 'address', header: '地址', width: '15rem' },
          { field: 'activeFlag', header: '生效', width: '4rem' },
        ],
        tableData: 'userInfo',
      },
      groups: {
        title: '群組頁面',
        cols: [
          // { field: 'service', header: '服務', width: '8rem' },
          { field: 'type', header: '種類', width: '8rem' },
          { field: 'name', header: '名稱', width: '8rem' },
          { field: 'code', header: '代碼', width: '8rem' },
      ...
      roles: {
        ...
        cols: [
          ...
          { field: 'name', header: '名稱', width: '8rem' },
          { field: 'code', header: '代碼', width: '8rem' },
          { field: 'description', header: '說明', width: '18rem' },
          { field: 'activeFlag', header: '生效', width: '4rem' },
        ],
        tableData: 'roles',
      },
      functions: {
        ...
        cols: [
          // { field: 'service', header: '服務', width: '8rem' },
          { field: 'label', header: '權限', width: '8rem' },
          { field: 'type', header: '種類', width: '8rem' },
          { field: 'name', header: '名稱', width: '8rem' },
          { field: 'code', header: '代碼', width: '10rem' },
          { field: 'description', header: '說明', width: '15rem' },
          { field: 'activeFlag', header: '生效', width: '5rem' },
        ],
        tableData: 'roles',
      },
    };
